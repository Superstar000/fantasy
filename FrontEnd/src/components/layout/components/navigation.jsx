        ...
        <div className="navbar1 text-center">
          {/* <a href="#"><img className="logo1" src="img/logo/logo2.png" alt="Logo" /></a> */}
            ...
            <a href="#/" style={{fontSize:'20px'}}>
              {" "}
              <i className="fa fa-fw fa-sm fa-home"></i>&ensp;Home
            </a>
         
          {this.props.auth.isAuthenticated ? (
            <a href="#/fantasyPoints" style={{fontSize:'20px'}}>
              <i className="fa fa-fw fa-sm fa-exchange-alt"></i>&ensp; Points
            </a>
          ) : (
            ""
          )}
          {this.props.auth.isAuthenticated ? (
            <a href="#/fantasypickteam"style={{fontSize:'20px'}}>
              <i className="fa fa-fw fa-sm fa-exchange-alt"></i>&ensp; Pick Team
            </a>
          ) : (
            ""
          )}
          ...
          {this.props.auth.isAuthenticated ? (
            <a href="#/fantasytransfer"style={{fontSize:'20px'}}>
              <i className="fa fa-fw fa-sm fa-exchange-alt"></i> &ensp;Transfer
            </a>
          ) : (
            ""
          )}
          ...
          {this.props.auth.isAuthenticated ? (
            <a href="#/fantasyleagues"style={{fontSize:'20px'}}>
              <i className="fa fa-fw fa-sm fa-futbol"></i>&ensp; Leagues
            </a>
          ) : (
            ""
          )}
          ...
          {this.props.auth.isAuthenticated ? (
            <a href="#/fantasyfixtures"style={{fontSize:'20px'}}>
              <i className="fa fa-fw fa-sm fa-globe"></i> &ensp;Fixtures
            </a>
          ) : (
            ""
          )}         
          ...
          <a href="#"style={{fontSize:'20px'}}>
            <i className="fa fa-fw fa-sm fa-podcast"></i>&ensp; Podcast
          </a>
          <a href="#/fantasystats"style={{fontSize:'20px'}}>
            <i className="fa fa-fw fa-sm fa-chart-bar"></i> &ensp;Stats
          </a>
          <a href="#/fantasyprizes"style={{fontSize:'20px'}}>
            <i className="fa fa-fw fa-sm fa-award"></i> &ensp;Prizes
          </a>
          <a href="#/fantasyhelp"style={{fontSize:'20px'}}>
            <i className="fa fa-fw fa-sm fa-question-circle"></i> &ensp;Help
          </a>
          <a href="#"style={{fontSize:'20px'}}>
            <i className="fa fa-fw fa-sm fa-buysellads"></i> &ensp;Draft
          </a>
          {this.props.auth.isAuthenticated ? (
            <a href="#" onClick={this.onLogoutClick}style={{fontSize:'20px'}}>
              <i className="fa fa-fw fa-sm fa-user"></i>&ensp; Sign Out
            </a>
          ) : (
            ""
          )}
