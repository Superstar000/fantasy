        ...
        <div className="col-md-12 col-sm-12 col-xs-12">
          <Card >
            <CardActionArea>    
              ...
              <div>
                  <Button  variant="contained" color="secondary" style={{textAlign:'left',marginRight:"20px"}}>
                    <font style={{textAlign:"left"}}><b>SIGN UP NOW</b></font>
                  </Button>
                   or 
                  <Button  variant="contained" color="primary" style={{marginLeft:'20px',marginRight:'20px',textAlign:'left'}}>
          ...
          <Card >
            <CardActionArea>             
              ...
              <div className="col-md-4">
                ...
                />
                <div className="fantasystatus">
                  CREATE OR JOIN A LEAGUE
                </div>
                <div className="fantasystatus1">
                  Take on friends and family or join public leagues against 
                  the Fantasy community.
                </div>
                <div>
                  <Button  style={{borderRadius:"20px"}} variant="contained" color="secondary" style={{marginLeft:'20px',marginRight:'20px',textAlign:'left'}}>
                    <font style={{textAlign:"left"}}><b>SIGN UP NOW</b></font>
                  </Button>
                </div>
               </div>
               <div className="col-md-4">
                ...
                <div>
                  <Button  variant="contained" color="secondary" style={{marginLeft:'20px',marginRight:'20px',textAlign:'left'}}>
                    <font style={{textAlign:"left"}}><b>SIGN UP NOW</b></font>
                  </Button>
                </div>
               </div>
