...
import { game_api1 } from "./../../../actions/gameapiAction";
    ...
    <div className={classes.container} id="buy-space">
      ...
      <div className="row" style={{ paddingLeft: "5%" }}>
        <div className="col-md-12 col-sm-12">
          <h3 style={{ color: "#585858", textAlign: "left" }}>Squad Selection</h3>
        </div>
              ...
              <div style={{ position: "relative", background: "#29386D" }}>
                ...
                >
                  <div className="col-md-12 col-sm-12 col-xs-12 text-center">
                    ...
                    <div className="col-md-6 col-md-6 col-xs-6 text-right">
                    <img src="/img/sportman.png" width="" />
                    </div>                    
                  </div>
                  <div className="col-md-12 col-sm-12 col-xs-12 text-center">
...
const mapStateToProps = (state) => ({
  auth: state.auth,
  errors: state.errors,
  game_api:state.game_api
});

export default connect(mapStateToProps, { game_api1})(withRouter(FantasySquad));
