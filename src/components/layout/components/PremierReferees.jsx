...
import Premierrefereescomponent from './subcomponent/Premierrefereescomponent';
...
export default function Premierreferees(props) {
  ...
  return (
    <div className={classes.container} id="buy-space">
      ...
      <h2 style={{color:"white",textAlign: 'left',paddingLeft:'5%'}}>Referees</h2>
      <div className="col-md-12 col-sm-12" style={{ padding: '0 5%' }}>        
          <Card >
            ...
            <CardActionArea>
                ...
                <div className="row premierplayers response_preplay" >                  
                   <div style={{float:'left'}}className="col-md-3 col-sm-6" > 
                   <b>Players</b>
                   </div>
                   <div style={{float:'left'}}className="col-md-3 col-sm-6"> 
                   <b>Matches</b>
                   </div>
                   <div style={{float:'left'}}className="col-md-3 col-sm-4">
                      Red Cards
                   </div>                   
                   <div style={{float:'left'}} className="col-md-3 col-sm-4">
                      Yellow Cards                  
