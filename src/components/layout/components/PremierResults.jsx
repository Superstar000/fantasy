...
import Premierresultcomponent from './subcomponent/Premierresultcomponent';
...
export default function FantasyHome(props) {
  ...
  return (
    <div className={classes.container} id="buy-space">
      ...
      <h2 style={{color:"white",textAlign: 'left',paddingLeft:'5%'}}>Results</h2>
      <div className="col-md-12 col-sm-12" style={{ padding: '0 5%' }}>        
          <Card >
            <div className="col-md-2 col-sm-6">
              ...
              </div><div className="col-md-1 col-sm-6">
              <FormControl className={classes.formControl}>
