...
export default function Com_pro_inspire(props){
          ...
          <div className="col-md-12 col-sm-12" style={{ padding: '0% 10% '}}> 
            ...
            <div className="col-md-8 col-sm-8">
                <CardContent> 
                  ...
                  <a href="#" className='com_pro_add'>Premire league primary inspires</a>
                  </Typography>
                  <div>&nbsp;</div>
                  <Typography variant="h6" color="textprimary" component="h4">             
                    Find out more about our education programme which is aimed at young people aged between 11-25
                  </Typography>
                </CardContent>  
            </div>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
            </Card > 
