        ...
        <CardActionArea>
          <CardContent style={{ padding: "0px" }}>
            ...
            >
              <div className="col-md-10 text-left">
                ...
                <font style={{ textAlign: "left" }}>
                  <b>Top Transfers In this Gameweek</b>
                </font>
              </div>
            ...
            <div className="col-md-12 col-xs-12 status-padding">
              ...
              <div className="col-md-2 col-xs-4">FWD</div>
              <div className="col-md-4 col-xs-6">
                <p> Iheanacho</p>
              </div>
              <div className="col-md-2 col-sm-6 statusborder-right">LIE</div>
              <div className="col-md-2 col-sm-6">141689</div>
            </div>
            <div className="col-md-12 col-xs-12 status-padding">
              <div className="col-md-1 col-xs-4">
                <img src="img/feather-info.png" alt="Cinque Terre" />
